  ...
  const CourseCard = ({ course, isPromoted = false }) => (
    <div className={`bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 ${isPromoted ? 'ring-2 ring-yellow-400' : ''}`}>
      ...
      <div className="p-6">
        ...
        <h3 className="text-lg font-semibold mb-2 text-gray-900 line-clamp-2">{course.title}</h3>
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            ...
            className="bg-gray-800 hover:bg-gray-900 text-white text-sm font-medium py-2 px-4 rounded transition"
          >
            View Details
          </Link>
        </div>
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
                <div className="md:col-span-2">
                  <input
                    ...
                    className="w-full px-4 py-3 text-gray-800 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <select
                  ...
                  className="px-4 py-3 text-gray-800 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                ...
                <button
                  type="submit"
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-3 px-6 rounded transition flex items-center justify-center"
                >
                  🔍 Search
                </button>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {courseCategories.map(category => (
              <button
                ...
                className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 text-center group"
              >
        ...
        <section className="py-16 bg-gradient-to-r from-yellow-50 to-orange-50">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-gray-900">🔥 Promoted Courses</h2>
              <Link to="/courses?promoted=true" className="text-blue-600 hover:text-blue-800 font-medium">
                View All →
              </Link>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link to="/courses?featured=true" className="text-blue-600 hover:text-blue-800 font-medium">
              View All Featured →
            </Link>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">Why Choose CivilsHQ?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 text-center hover:shadow-md transition">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900">Verified Reviews</h3>
              <p className="text-gray-600 text-sm">
      ...
      <section className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Start Your UPSC Journey?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/courses"
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded text-lg transition"
            >
              Browse All Courses
            </Link>
            <Link
              to="/signup"
              className="bg-white text-gray-800 hover:bg-gray-100 font-bold py-3 px-8 rounded text-lg transition"
            >
              Create Account
            </Link>
          </div>
